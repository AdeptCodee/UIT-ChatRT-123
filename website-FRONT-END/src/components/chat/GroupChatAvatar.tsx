...
const GroupChatAvatar = ({ participants, type }: GroupChatAvatarProps) => {
  ...
  return (
    <div className="relative flex -space-x-2 *:data-[slot=avatar]:ring-background *:data-[slot=avatar]:ring-2">
      {avatars}
      {/* Nếu group có nhiều hơn 4 thành viên */}
      {participants.length > limit && (
        <div className="flex items-center z-10 justify-center size-8 rounded-full bg-mute ring-2 ring-background text-muted-foreground">
